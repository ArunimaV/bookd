      ...
      >
        <div
          className={cn(
            ...
            "after:bg-[radial-gradient(circle_at_50%_50%,rgba(251,146,60,0.15),transparent_70%)]"
          )}
        />
      </motion.div>
    </motion.div>
...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#faf9f7]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 border border-orange-200/60 mb-8 md:mb-12"
          >
          ...
          >
            <Link
              href="/onboarding"
              className="group inline-flex items-center gap-2 px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-orange-500 to-amber-500 rounded-full hover:from-orange-600 hover:to-amber-600 transition-all duration-300 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105"
            >
              Get Started
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#faf9f7] via-transparent to-[#faf9f7]/80 pointer-events-none" />
    </div>
  );
}
